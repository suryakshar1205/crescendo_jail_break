...
Executes all 32 certified test cases across all subsystems in a single command:
...
def load_master_suite() -> unittest.TestSuite:
    """Compiles all 32 certified master test cases directly from test classes."""
...
def main():
    ...
    print("=" * 70)
    print("CRESCENDO JAILBREAK DEFENSE -- MASTER TEST SUITE (32 TESTS)")
    print("=" * 70)
    ...
    print(f"  * Status          : {'ALL 32 TESTS PASSED (100% SUCCESS)' if result.wasSuccessful() else 'TEST FAILURES DETECTED'}")
    print("=" * 70)
