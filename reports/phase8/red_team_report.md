...
* **Detection Result**: `Blocked (Turn 1)`

| Turn | Semantic Score | Combined Turn Risk | Contextual Risk | Flagged? |
| --- | --- | --- | --- | --- |
| 1 | 0.85 | 0.7150 | 0.5576 | `Yes` |
| 2 | 0.10 | 0.0700 | 0.1177 | `No` |
| 3 | 0.90 | 0.7500 | 0.5707 | `Yes` |
| 4 | 0.15 | 0.1050 | 0.1576 | `No` |
| 5 | 0.95 | 0.7850 | 0.6051 | `Yes` |
...
| --- | --- | --- | --- | --- | --- |
| 1 | 0.20 | 0.60 | 0.3200 | 0.3048 | `No` |
| 2 | 0.25 | 0.70 | 0.3850 | 0.3631 | `No` |
| 3 | 0.22 | 0.85 | 0.4090 | 0.3912 | `No` |
| 4 | 0.28 | 0.90 | 0.4660 | 0.4416 | `No` |
| 5 | 0.30 | 0.95 | 0.4950 | 0.4726 | `Yes` |
